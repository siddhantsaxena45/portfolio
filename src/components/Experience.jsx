      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-display font-bold mb-8">History</h3>
          </motion.div>

          <div className="lg:w-2/3 border-l border-white/5 pl-6 md:pl-16 ml-2 md:ml-0">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute left-[-29px] md:left-[-69px] top-2 w-3 h-3 rounded-full bg-accent" />
              <div>
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                  <h4 className="text-xl md:text-2xl font-display font-bold text-white">Research Intern</h4>
                  <span className="text-xs font-bold text-muted uppercase tracking-widest">DRID, JIIT | May 2025 - Jul 2025</span>
                </div>
                <ul className="text-muted text-base md:text-lg mb-8 leading-relaxed max-w-2xl list-disc pl-5 space-y-2">
